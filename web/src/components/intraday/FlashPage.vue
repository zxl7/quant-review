...
.flash-btn.up.active {
  ...
  background: rgba(230, 0, 18, 0.08);
  box-shadow: inset 0 0 0 1px rgba(230, 0, 18, 0.04);
}

.flash-btn.down.active {
  color: #00a63e;
  border-color: rgba(0, 166, 62, 0.22);
  background: rgba(0, 166, 62, 0.08);
  box-shadow: inset 0 0 0 1px rgba(0, 166, 62, 0.04);
}

.flash-btn.warn.active {
  color: #e60012;
...
.flash-bkj {
  ...
  font-weight: 800;
  color: #0f9fb4;
  background: rgba(15, 159, 180, 0.08);
  border: 1px solid rgba(15, 159, 180, 0.18);
}

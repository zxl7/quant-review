...
- `abnormal_event_history-20260522.json`：未知文件，保守保留
- `abnormal_event_history-20260525.json`：未知文件，保守保留
- `abnormal_event_history-20260526.json`：未知文件，保守保留
- `abnormal_event_history-20260527.json`：未知文件，保守保留
- `abnormal_event_history-20260528.json`：未知文件，保守保留
- `abnormal_event_history-20260529.json`：未知文件，保守保留
- `abnormal_event_history-20260601.json`：未知文件，保守保留
...
- `abnormal_event_history-20260609.json`：未知文件，保守保留
- `abnormal_event_history-20260610.json`：未知文件，保守保留
- `abnormal_event_history-20260611.json`：未知文件，保守保留
- `abnormal_event_history-20260612.json`：未知文件，保守保留
- `account_nav_history.jsonl`：未知文件，保守保留
...
- `intraday_slices-20260612.json`：保留最近 2 个盘中切片
...
- `market_data-20260609.json`：最近 7 个 market_data 快照
- `market_data-20260610.json`：最近 7 个 market_data 快照
- `market_data-20260611.json`：最近 7 个 market_data 快照
- `market_data-20260612.json`：最近 7 个 market_data 快照
...
- `market_data-20260604-intraday.json`：超出最近 7 个 market_data 快照

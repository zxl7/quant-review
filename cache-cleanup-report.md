...
- `intraday_slices-20260601.json`：保留最近 2 个盘中切片
- `learning_notes_history.json`：学习语录去重历史
- `market_data-20260522.json`：最近 7 个 market_data 快照
- `market_data-20260525.json`：最近 7 个 market_data 快照
- `market_data-20260526.json`：最近 7 个 market_data 快照
...
- `market_data-20260521.json`：超出最近 7 个 market_data 快照

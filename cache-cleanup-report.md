...
- `cache/abnormal_event_history-20260617.json`：保留最近 7 天 abnormal event history 缓存
- `cache/abnormal_event_history-20260622.json`：保留最近 7 天 abnormal event history 缓存
- `cache/abnormal_event_history-20260623.json`：保留最近 7 天 abnormal event history 缓存
- `cache/abnormal_event_history-20260624.json`：保留最近 7 天 abnormal event history 缓存
- `cache/abnormal_event_history-20260703.json`：保留最近 7 天 abnormal event history 缓存
- `cache/abnormal_event_history-20260724.json`：保留最近 7 天 abnormal event history 缓存
...
- `cache/market_data-20260617.json`：保留最近 7 天 market_data 快照
- `cache/market_data-20260622.json`：保留最近 7 天 market_data 快照
- `cache/market_data-20260623.json`：保留最近 7 天 market_data 快照
- `cache/market_data-20260624.json`：保留最近 7 天 market_data 快照
- `cache/market_data-20260703.json`：保留最近 7 天 market_data 快照
- `cache/market_data-20260724.json`：保留最近 7 天 market_data 快照
...
- `cache/stock_research_realtime_quotes-20260616.json`：保留最近 7 天 stock research realtime quotes 缓存
- `cache/stock_research_realtime_quotes-20260624.json`：保留最近 7 天 stock research realtime quotes 缓存
...
- `cache_online/eastmoney_theme_stocks-20260624.json`：保留最近 7 天 eastmoney theme stocks 缓存
- `cache_online/eastmoney_theme_stocks-20260703.json`：保留最近 7 天 eastmoney theme stocks 缓存
...
- `cache_online/eastmoney_tomorrow_themes-20260624.json`：保留最近 7 天 eastmoney tomorrow themes 缓存
- `cache_online/eastmoney_tomorrow_themes-20260703.json`：保留最近 7 天 eastmoney tomorrow themes 缓存
- `cache_online/manifest.json`：线上同步 manifest，会覆盖更新
- `cache_online/market_data-20260703.json`：未知文件，保守保留
...
- `cache_online/ths_newhigh-20260617.json`：保留最近 7 天 ths newhigh 缓存
- `cache_online/ths_newhigh-20260622.json`：保留最近 7 天 ths newhigh 缓存
- `cache_online/ths_newhigh-20260623.json`：保留最近 7 天 ths newhigh 缓存
- `cache_online/ths_newhigh-20260624.json`：保留最近 7 天 ths newhigh 缓存
- `cache_online/ths_newhigh-20260703.json`：保留最近 7 天 ths newhigh 缓存
- `cache_online/ths_newhigh-20260724.json`：保留最近 7 天 ths newhigh 缓存
...
- `cache_online/watchlist_cache-20260624.json`：保留最近 7 天 watchlist cache 缓存
- `cache_online/watchlist_cache-20260703.json`：保留最近 7 天 watchlist cache 缓存
...
- `cache_online/xuangubao_abnormal-20260624.json`：保留最近 7 天 xuangubao abnormal 缓存
- `cache_online/xuangubao_abnormal-20260703.json`：保留最近 7 天 xuangubao abnormal 缓存
...
- `cache_online/xuangubao_surge_plates-20260624.json`：保留最近 7 天 xuangubao surge plates 缓存
- `cache_online/xuangubao_surge_plates-20260703.json`：保留最近 7 天 xuangubao surge plates 缓存
- `daily_review/output/tonghuashun/sync-2026-06-16.txt`：保留最近 7 天同花顺同步输出
- `daily_review/output/tonghuashun/sync-2026-06-17.txt`：保留最近 7 天同花顺同步输出
- `daily_review/output/tonghuashun/sync-2026-06-22.txt`：保留最近 7 天同花顺同步输出
- `daily_review/output/tonghuashun/sync-2026-06-23.txt`：保留最近 7 天同花顺同步输出
- `daily_review/output/tonghuashun/sync-2026-06-24.txt`：保留最近 7 天同花顺同步输出
- `daily_review/output/tonghuashun/sync-2026-07-03.txt`：保留最近 7 天同花顺同步输出
- `daily_review/output/tonghuashun/sync-2026-07-24.txt`：保留最近 7 天同花顺同步输出
